...
dir_list = sorted(glob(op.join('/d/gmi/1/sebastiancoleman/MEG_setshifting/subjects_dir', '*')))
...
mne.viz.plot_alignment(raw.info, coreg.trans, subject, subjects_dir, fig=fig, 
                       coord_frame='mri', mri_fiducials=True, surfaces='head-dense',
                       dig=True)
